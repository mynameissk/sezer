...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Sebep yazmalısın.');
  if (message.mentions.users.size < 1) return message.reply('kimi kickleyeğimi yazmalısın.').catch(console.error);
