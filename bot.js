...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === prefix +'instagram') {
    msg.reply('@biraderizim');
  }
  if (msg.content.toLowerCase() === prefix + 'admin') {
    msg.reply('@yucetigirer - @m.mert.pinar - @sezerkaraoglan7');
  }
  if (msg.content.toLowerCase() === prefix + 'yaratıcı' ) {
  msg.reply('Sezer')
  }
  if (msg.content.toLowerCase() === prefix + 'mersin içi pasif' ) {
  msg.reply('Onur şuan meşgul 5 kişi onuru dönüyor lütfen daha sonra tekrar deneyiniz.')
}
});
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**? | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('BİRADERİZM | Şarkı Seçimi')
...
function play(guild, song) {
  ...
  .setTitle("**BİRADERİZM | :microphone: Müzik Başladı**")
